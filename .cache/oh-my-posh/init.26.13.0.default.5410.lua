...
local omp_executable = 'C:/Users/Shin/AppData/Local/Programs/oh-my-posh/bin/oh-my-posh.exe'

-- Configuration

os.setenv('POSH_THEME', 'E:\\khrowno\\$(oh-my-posh get init --config default)')
